...
function(add_compiler_rt_custom_cxx name type)
	...
	set(libnames ${libnames} ${libname})
		...
		link_directories("/polytracker/polytracker/dfsan/dfsan_rt/dfsan_private_headers/lib")
		include_directories("/polytracker/polytracker/dfsan/dfsan_rt/dfsan_private_headers/include/c++/v1")
		set(extra_cflags_${libname} "-stdlib=libc++" "-nostdinc++ -g" ${TARGET_${X86_64}_CFLAGS} ${LIB_CFLAGS})
	#Add link dir with the ABI
	set(POLY_LIB_PATH "/polytracker/polytreacker/dfsan/dfsan_rt/dfsan_private_headers/lib")
