...
class TDInfo(Command):
    ...
    def __init_arguments__(self, parser):
        ...
        parser.add_argument(
            ...
            "-s",
            action="store_true",
            help="print taint sinks (very slow for large traces)",
        )
        parser.add_argument(
            "--print-taint-nodes",
            "-n",
            action="store_true",
            help="print taint nodes (very slow for large traces)",
        )
        ...
        parser.add_argument(
            ...
            "-c",
            action="store_true",
            help="print control flow log events (very slow for large traces)",
        )
