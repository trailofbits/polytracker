rm testme.*
rm track.*
cp test_object_propagation.cpp testme.cpp
# Static, make sure that you pull in all of libcxx 
gclang++ -stdlib=libc++ -static -fPIC -fPIE -I/cxx_libs/clean_build/include/c++/v1 -L/cxx_libs/clean_build/lib -g -o testme.o testme.cpp -Wl,--start-group /cxx_libs/clean_build/lib/libc++.a /cxx_libs/clean_build/lib/libc++abi.a -ldl -lpthread -Wl,--end-group
