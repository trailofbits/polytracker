...
def parse_format_v2(polytracker_json_obj: dict) -> ProgramTrace:
    ...
    return ProgramTrace(polytracker_version=(0, 0, 1, "alpha2.1"), function_data=function_data)
...
def parse_format_v3(polytracker_json_obj: dict) -> ProgramTrace:
    ...
    return ProgramTrace(polytracker_version=version, function_data=function_data)
