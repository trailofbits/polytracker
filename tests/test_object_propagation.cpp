 ...
 * and getters/setters
 *
 * It also tests to see if the tracking handles copying objects with tainted
 * data appropriately
 */
...
public:
  ...
  ~Container() {}
  std::string getString() { return stored_string; }
  void setString(std::string new_str) { stored_string = new_str; }
