...
/*
 * This testcase checks to see that we can pass data through cxx standard templates like vector
 */

class VectorContainer {
public:
	VectorContainer(std::vector<std::string> str_vec) {
		string_vec = str_vec;
	}
	~VectorContainer() {}
	//It might not mark as tainted in this function, but it should here or in some cxx function
	void printAllItems() {
