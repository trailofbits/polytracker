...
/*
 * This is a simple test case that tests for taint source acquisition via ifstream, 
 * and some simple propagation through functions and targeted checks. 
 */
...
//Should touch the entire file, but its possible that it goes into a cxx lib instead, so its hard to see. 
